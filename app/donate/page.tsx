...
export default function DonatePage() {
  return (
    <div className="min-h-screen flex flex-col">
      <NavbarSection />
      <main className="flex-1 bg-neutral-950 flex flex-col items-center justify-center p-6 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/20 via-neutral-950 to-neutral-950 py-20">
          ...
          {[
            {
              icon: "🚀",
              title: "Fast",
              desc: "Instant processing via Stripe",
            },
